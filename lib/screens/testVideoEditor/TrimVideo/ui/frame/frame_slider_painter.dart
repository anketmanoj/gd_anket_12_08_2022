...
class FrameSliderPainter extends CustomPainter {
  FrameSliderPainter(this.rect, this.position, this.style);
  ...
  @override
  bool shouldRepaint(FrameSliderPainter oldDelegate) => true;

  @override
  bool shouldRebuildSemantics(FrameSliderPainter oldDelegate) => false;
}
