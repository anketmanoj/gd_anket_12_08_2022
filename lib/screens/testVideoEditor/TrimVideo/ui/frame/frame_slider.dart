...
class FrameSlider extends StatefulWidget {
  ...
  @override
  _FrameSliderState createState() => _FrameSliderState();
}

class _FrameSliderState extends State<FrameSlider>
    with AutomaticKeepAliveClientMixin<FrameSlider> {
  ...
  double _getTrimPosition() {
    print(
        "thumbnail position ${_fullLayout.width * widget.controller.trimPosition - _thumbnailPosition + widget.horizontalMargin}");
