...
class EditDraftPreviewVideoScreen extends StatefulWidget {
  const EditDraftPreviewVideoScreen({
    Key? key,
    required this.videoFile,
  }) : super(key: key);

  final DraftVideo videoFile;

  @override
  State<EditDraftPreviewVideoScreen> createState() =>
      _EditDraftPreviewVideoScreenState();
}

class _EditDraftPreviewVideoScreenState
    extends State<EditDraftPreviewVideoScreen> {
                              ...
                              function: () async {
                                if (_formKey.currentState!.validate() &&
                                  ...
                                  try {
                                    ...
                                    firebaseOperations
                                        .goFromDraftToPosts(
                                      isverifiedVal: context
                                          .read<FirebaseOperations>()
                                          .getIsVerified,
                                      coverThumbnailUrl:
                                          widget.videoFile.thumbnailurl,
                                      id: widget.videoFile.id,
                                      userUid: widget.videoFile.useruid,
                                      videoUrlVal: widget.videoFile.videourl,
...
class ImageTitleAndCaption extends StatelessWidget {
  ...
  final Size size;
  final EditDraftPreviewVideoScreen widget;
