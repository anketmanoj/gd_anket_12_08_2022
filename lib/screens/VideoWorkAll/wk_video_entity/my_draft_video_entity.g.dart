...
_$_MyDraftVideoEntity _$$_MyDraftVideoEntityFromJson(
        Map<String, dynamic> json) =>
    _$_MyDraftVideoEntity(
      id: json['id'] ?? -1,
      ...
      listLayer: (json['listLayer'] as List<dynamic>?)
              ?.map((e) =>
                  DraftVideoItemEntity.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
    );

Map<String, dynamic> _$$_MyDraftVideoEntityToJson(
