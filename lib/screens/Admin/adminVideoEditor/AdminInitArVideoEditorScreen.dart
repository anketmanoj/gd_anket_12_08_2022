...
class AdminArVideoEditorScreen extends StatefulWidget {
  const AdminArVideoEditorScreen(
      {Key? key, required this.file, required this.userModel})
      : super(key: key);
  ...
  @override
  _AdminArVideoEditorScreenState createState() =>
      _AdminArVideoEditorScreenState();
}

class _AdminArVideoEditorScreenState extends State<AdminArVideoEditorScreen> {
                                ...
                                ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    await Provider.of<ArVideoCreation>(context,
                                      ...
                                      ownerName: widget.userModel.username,
