...
class AdminPreviewPexelVideoScreen extends StatefulWidget {
  const AdminPreviewPexelVideoScreen({Key? key, required this.pexelVideoUrl})
      : super(key: key);
  final String pexelVideoUrl;

  @override
  State<AdminPreviewPexelVideoScreen> createState() =>
      _AdminPreviewPexelVideoScreenState();
}

class _AdminPreviewPexelVideoScreenState
    extends State<AdminPreviewPexelVideoScreen> {
