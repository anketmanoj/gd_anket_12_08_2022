...
import 'package:diamon_rose_app/screens/Admin/adminVideoEditor/AdminArPreviewScreen.dart';
...
class AdminGDARNotificationScreen extends StatelessWidget {
  const AdminGDARNotificationScreen({Key? key, required this.userModel})
      : super(key: key);
